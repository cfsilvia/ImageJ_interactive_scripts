...
//////////////////////////////////////////////////////////////////    
 ...
 //////////////////////   
    ...
    Index = FindIndexArray(RawRegion,rName,numrows );
    print(Index);
    if(Index > -1){
...
//waitForUser;ADD IF SkeletonizedAxons SELECTION IS -1 -tHEN ALLL RESULtS ARE ZERO
...
  if(SkeletonizedAxons == -1) { //if no fibers were detected
       ...
       // run("Analyze Particles...", "size=MinAxonLength show=Masks"); ---Remove

        //run("Create Selection"); //creates a composite--Remove 
        //run("Measure"); Remove--
/////////////////////////////
    if(SkeletonizedAxons!= -1) { //onlly when there are fibers
      ...
      waitForUser('stop');
       ...
       //selectWindow("Results"); 
        saveAs("Results", myDir + "\\Tracing Data Details for Image" + FileList[i] + rName + ".xls");
		// if(isOpen("Tracing Data Details for Image" + StringyList[i] + rName + ".xls")){
...
/////////////////////////////Add information to all axons///////////////////////////////
      ...
      if(NumberOfBranches==0 || SkeletonizedAxons == -1 ){
...
///////////////////////////////////////////////////////////////////////////////////////		
        ...
        wait(25);
       // saveAs("Tiff", myDir + Coolstring[0] + rName + "a.tif");
        //Add silvia
        close(); 
...
//if(r==8){
 //waitForUser("stop");//}
     //   }
        ...
        //run("Save", "save=[" + myDir + Coolstring + rName + "b.tif" + "]");
        //rename("toOverlay");
        if (r == 0){
        open(stringy + "Fibers/" + FileList[i]);
        wait(25);
      ...
      // waitForUser;
       ...
       if(File.exists(myDir + "f" + Coolstring + ".tif" )){ 	
