...
//
 ...
 //Calibrate your region
   Dialog.create(" ");
   Dialog.addCheckbox("	Begin or continue your calibration", false);
   Dialog.show();
 ...
 while(a){ // finish when the user calibrate all the regions
  //get image with axons for calibration
   ...
   Dialog.addString("ADD EXACTLY THE NAME OF THE REGION YOU USE IN THE ROI- only left or right", "");
   Dialog.addMessage("IMAGE REPRESENTATIVE OF YOUR REGION -USE THE MONTAGE");
...
//////////////////////////////////////////////////////////////////////////////////
    ...
    Minimo=min;
    Maximo=max;
    waitForUser("Please place this box over an area with representative axons intensities you want to detect, you can change its size if you wish, Click OK when done.");
